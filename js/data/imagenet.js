/**
 * imagenet.js — ImageNet-1k class list in model index order (0-999).
 *
 * Generated from the canonical synset list; the order is what the
 * EfficientNet-Lite4 head was trained on, so index i is the label for
 * logit i. Kept as prose (not the raw synset id) because it is what gets
 * spoken aloud.
 */
...
export const IMAGENET_COUNT = IMAGENET_LABELS.length;
